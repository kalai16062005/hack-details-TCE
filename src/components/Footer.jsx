    ...
    <footer className="bg-black text-white py-12 px-4 font-sans border-t border-gray-900">
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-black tracking-[0.2em] mb-2">CODEASTHRAM CHALLENGE</h2>
          ...
          <p className="text-gray-400 text-sm md:text-base tracking-wide uppercase">
            Department of Information Technology | Thiagarajar College of Engineering (TCE), Madurai
          </p>
        </div>

        {/* Credentials Grid - 2 columns side by side */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-center w-full max-w-3xl mb-12 border-b border-gray-800 pb-12">
          <div className="space-y-2">
            <h3 className="text-blue-500 font-bold text-xs uppercase tracking-[0.15em]">Principal</h3>
            <p className="font-semibold text-lg text-gray-100">Dr.L.Ashok Kumar, M.E.,Ph.D.,</p>
          </div>

          <div className="space-y-2">
            <h3 className="text-blue-500 font-bold text-xs uppercase tracking-[0.15em]">Head of Department</h3>
            <div className="space-y-1">
              <p className="font-semibold text-lg text-gray-100">Dr.C.Deisy, M.E., Ph.D.,</p>
              <p className="font-medium text-md text-gray-400">Professor & Head</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-gray-400 text-xs md:text-sm tracking-wide">
            TCE, Madurai — 65 Years of Excellence
          </p>
          <div className="pt-6">
